...
function (_React$Component) {
  ...
  Object(_babel_runtime_corejs2_helpers_esm_createClass__WEBPACK_IMPORTED_MODULE_1__["default"])(Prices, [{
    ...
    value: function render() {
      ...
      if (this.state.currency === 'GBP') {} else if (this.state.currency === 'USD') {} else if (this.state.currency === 'EUR') return __jsx("div", {
        __source: {
...
//# sourceMappingURL=index.js.272c9db2d8bfa7ea5f54.hot-update.js.map